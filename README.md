...
- **阶段 1（当前，v0.7.0 已收官）**：Mac 终端单人 SOLO 版。Python + Rich 纯文字界面，支持存档/读档、简单/困难难度、分阶段局后统计（资源收支/骰面分布/对局回看）、历史最佳与评级。
...
- **测试**：无头前端 + pytest 规则回归（当前 111 项全部通过）。
...
- `docs/玩家使用指南.md`：安装、启动、操作与存档说明（v0.7.0 起）。
